...
/*   Updated: 2023/05/17 15:47:21 by paulorod         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_print_invalid_format(char *fmt, int *w_bytes, int *i)
{
...
int	ft_print_parse(int expected_args, char *fmt, va_list args)
{
	int	i;
	int	w_bytes;
